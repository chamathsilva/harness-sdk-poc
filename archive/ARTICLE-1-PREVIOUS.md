...
Status: previous draft, pending rewrite against ARTICLE-PLAN.md and ARTICLE-1-OUTLINE.md.
The earlier review counted 4,076 words of prose. The new editorial target is 2,200–2,800.
This text has not yet been rewritten under the new plan. The external doc above is
the source snapshot; consult the active plan before importing or overwriting revisions.
Do not treat the earlier fact-check as publication clearance: ARTICLE-PLAN.md records
open scoring, dataset-description, and code-example issues that affect this text.
-->
